...
npy_path='/root/PBHC_g1_SingleWaistYaw/logs/MotionTracking/20250715_101857-looser_JumpJumpJump_RandHard_IterationRecord-motion_tracking-g1_23dof/iteration_data_collection/iteration_16_env0_data.npy'
#npy_path='/root/PBHC_g1_SingleWaistYaw/logs/MotionTracking/20250714_163037-LOOSE_JumpJumpJump_RandViscous_Hard_IterationRecord-motion_tracking-g1_23dof/rigid_body_inertia.npy'
...
for key in saved_data.keys():
    #print(f"Key: {key}, Type: {type(saved_data[key])}, Length: {len(saved_data[key])} ")
    selected = key
    #selected='dof_pos'
    print(f'\nselected: {selected}')
    ...
    print(saved_data[selected][0].shape)
    print(saved_data[selected][0])
