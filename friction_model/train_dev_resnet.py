...
def main():
    ...
    # Defines the output dimension of each of the 3 residual blocks.
    # e.g., Block 1 outputs 1024, Block 2 outputs 512, Block 3 outputs 256
    ...
    experiment_name = 'dev_resnet_DimEdited_friction_lr1e-4_batch1024' # Default experiment name
    for arg in sys.argv:
